  ...
  return (
    ...
    >
      ...
      <group position={[0, 2.5, 0]}>
        ...
        {/* Pigtails — rotated so the cone tip points downward */}
        <mesh position={[-0.8, -0.2, -0.2]} rotation={[0, 0, Math.PI - 0.5]} castShadow>
      ...
      {/* Belt Buckle (Heart) */}
      <mesh position={[0, 0.95, 0.38]} rotation={[0, 0, Math.PI / 4]}>
      ...
      {/* Arms */}
      <mesh position={[-0.55, 1.2, 0]} rotation={[0, 0, -0.3]} castShadow>
