...
export function DoorEntrance({ onEnter, signUrl }: DoorEntranceProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-40 flex items-center justify-center text-white font-sans overflow-hidden"
          ...
          >
            <div className="group relative" style={{ perspective: '1200px' }}>
              ...
              >
                ...
                {/* Door handle */}
                <div
                  className="absolute right-4 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full transition-colors"
                  style={{ backgroundColor: COLORS.DOOR_HANDLE }}
                />
              </div>
