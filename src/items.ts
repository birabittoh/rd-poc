...
export const ITEM_DEFINITIONS: Record<ItemType, ItemDefinition> = {
  table: { type: "table", category: "floor", size: 1, connectable: true, rotationStrategy: "faceAwayFromWall" },
  ...
  tv: { type: "tv", category: "surface", size: 1, connectable: true, rotationStrategy: "faceAwayFromWall" },
