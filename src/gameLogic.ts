...
export function createInitialState(): GameState {
  return {
    furniture: [
      { id: 'initial-1', type: 'bed', x: 0, y: 0, z: 0, rotation: 0, variant: 1 },
      { id: 'initial-2', type: 'bedside_table', x: 1, y: 0, z: 0, rotation: 0, variant: 0 },
      { id: 'initial-3', type: 'book', x: 1, y: 0, z: 1, rotation: 0, variant: 3 },
      { id: 'initial-4', type: 'drawer', x: GRID_SIZE - 1, y: GRID_SIZE - 1, z: 0, rotation: Math.PI, variant: 0 },
      { id: 'initial-5', type: 'boombox', x: GRID_SIZE - 1, y: GRID_SIZE - 1, z: 1, rotation: Math.PI, variant: 3 },
      { id: 'initial-6', type: 'table', x: GRID_SIZE - 1, y: CENTER - 1, z: 0, rotation: -Math.PI / 2, variant: 0 },
      { id: 'initial-7', type: 'chair', x: GRID_SIZE - 2, y: CENTER - 1, z: 0, rotation: Math.PI / 2, variant: 0 },
    ],
    ballerina: {
      x: CENTER,
      y: CENTER,
